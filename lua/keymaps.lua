-- Legacy keymaps file - moved to lua/config/keymaps.lua
...
-- การเลือกและคัดลอก
map('n', 'J', 'mzJ`z')                          -- รวมบรรทัดจากด้านล่าง คงตำแหน่งเคอร์เซอร์
map('n', 'K', 'kJ')                             -- รวมบรรทัดจากด้านบน โดยขึ้นไป 1 บรรทัดแล้วใช้ J
